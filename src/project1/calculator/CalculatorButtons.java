...
public class CalculatorButtons {
	...
	public static JTextField textField = new JTextField(36);
	...
	public void addButtons(JFrame frame)
	{
		...
		buttonClear.setPreferredSize(new Dimension(102,40));
		buttonBackSpace.setPreferredSize(new Dimension(103,40));
		buttonCE.setPreferredSize(new Dimension(103,40));
		...
		buttonPanel.add(Box.createRigidArea(new Dimension(69,0)));
